...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.02 ephBonusB 0.02 ephStartRatio 0.4 ephBuildingRatio 0.5 ephReusingRatio 0.375 ephPopHistory 0 threads 72 cycles 0 ephTime 30 buildingTime 10 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB 1 bBA 0.97 bBB 0.97 cheaterA 0.13333 cheaterB 0.4  sBA 1.0 >> a5g5.txt	
