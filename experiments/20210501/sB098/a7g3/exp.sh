...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.07 ephBonusB 0.03 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads $THREADNUM cycles 5000 ephTime $EPHTIME ni 0 sampleId $i printPartials 1 rBMA 0.42857 rBMB 2.3333 bBA $BETA_A bBB $BETA_B sBA 0.98 sBB 0.98 >> a7g3.txt
