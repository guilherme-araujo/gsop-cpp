...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.09 ephBonusB 0.01 ephStartRatio 0.6 ephBuildingRatio 0.6666 ephReusingRatio 0.1666 ephPopHistory 0 threads $THREADNUM cycles 5000 ephTime $EPHTIME ni 0 sampleId $i printPartials 1 rBMA 0.1111 rBMB 9 bBA $BETA_A bBB $BETA_B sBA 0.98 sBB 0.98 >> a9g1.txt
