...
do
	...
	./$FILE samples 5000 ephStartRatio 0.55 ephBuildingRatio 0.8181 ephReusingRatio 0.0909 ephBonus 0.01 ephBonusB 0.08 ephPopHistory 0 threads 72 cycles 5000 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 8 rBMB 0.125 bBA 0.95 bBB 0.95 >> exp.txt	
