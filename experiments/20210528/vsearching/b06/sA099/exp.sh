...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.06 ephBonusB 0.05 ephStartRatio 0.4 ephBuildingRatio 0.5 ephReusingRatio 0.375 ephPopHistory 0 threads 72 cycles 0 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB 1 bBA 0.95 bBB 0.95 cheaterA 0.6666 aOnly 1 sBA 0.99 >> a5g5.txt	
