...
files = [
    ...
    {'file': 'a2g3', 'bonus': np.log(2.0)}, #'ωA/ωB = 2.0'
    {'file': 'a2g4', 'bonus': np.log(3.0)}, #'ωA/ωB = 3.0'
    {'file': 'a2g5', 'bonus': np.log(4.0)}, #'ωA/ωB = 4.0'
    {'file': 'a2g6', 'bonus': np.log(5.0)}, #'ωA/ωB = 5.0'
    {'file': 'a2g7', 'bonus': np.log(6.0)}, #'ωA/ωB = 6.0'
    {'file': 'a2g8', 'bonus': np.log(7.0)}, #'ωA/ωB = 7.0'
]

files2 = [
    {'file': 'b2g3', 'bonus': np.log(0.5)}, #'ωA/ωB = 0.5'
    {'file': 'b2g4', 'bonus': np.log(0.333)}, #'ωA/ωB = 0.333'
    {'file': 'b2g5', 'bonus': np.log(0.25)}, #'ωA/ωB = 0.25'
    {'file': 'b2g6', 'bonus': np.log(0.2)}, #'ωA/ωB = 0.2'
    {'file': 'b2g7', 'bonus': np.log(0.167)}, #'ωA/ωB = 0.167'
    {'file': 'b2g8', 'bonus': np.log(0.143)}, #'ωA/ωB = 0.143'
]
