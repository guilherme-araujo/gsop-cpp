...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.1 ephBonusB 0.1 ephStartRatio 0.4 ephBuildingRatio 0.5 ephReusingRatio 0.375 ephPopHistory 0 threads 72 cycles 0 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB 1 bBA 0.95 bBB 0.95 cheaterA 0.13333 cheaterB 0.4  sBA 0.97 sBB 0.97 >> a5g5.txt	
