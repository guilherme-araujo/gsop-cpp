...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.04 ephBonusB 0.04 ephStartRatio 0.4 ephBuildingRatio 0.5 ephReusingRatio 0.375 ephPopHistory 0 threads 72 cycles 0 ephTime 30 ni 0 sampleId $i printPartials 1 rBMA 1 rBMB 1 bBA 1.0 bBB 1.0 cheaterA 0.13333 cheaterB 0.4  sBA 0.96 sBB 0.96 >> a5g5.txt	
