...
if [ -f "$FILE" ]; then
	...
	do
		...
		./$FILE samples 1000 ephBonus 0.01 ephBonusB 0.01 ephStartRatio 0.4 ephBuildingRatio 0.5 ephReusingRatio 0.375 ephPopHistory 0 threads 72 cycles 0 ephTime 30 ni 0 sampleId $i printpartials 1 lockABEph 1 rBMA 1 rBMB 1 bBA 0.95 bBB 0.95 cheaterA 0.13333 cheaterB 0.4  sBA 0.99 sBB 0.99 >> a5g5.txt	
